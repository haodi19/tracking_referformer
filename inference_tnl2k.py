...
def main(args):
    ...
    data_root_path = "/ssd1/luojingnan/TNL2K_test_subset/test_data"
    # video_list = os.listdir(data_root_path)
    video_list = ["advSamp_Baseball_game_002-Done"]
...
def sub_processor(lock, pid, args, save_path_prefix, save_visualize_path_prefix, video_list, data_root_path):
    ...
    for sub_path in video_list:
        ...
        video_path = os.path.join(data_path, "imgs")
        expression_path = os.path.join(data_path, "language.txt")
